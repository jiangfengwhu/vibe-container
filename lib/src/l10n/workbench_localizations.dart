...
class WorkbenchLocalizations {
  ...
  String get importGeneratedTitle => _text('importGeneratedTitle');
  String get importGeneratedBody => _text('importGeneratedBody');
  String get chooseIprodZip => _text('chooseIprodZip');
...
const _localizedValues = <String, Map<String, String>>{
  'zh': <String, String>{
    ...
    'importGeneratedTitle': '导入生成的 bundle',
    'importGeneratedBody': '选择由 Codex 或其他编码代理生成的 .iprod.zip bundle。',
    'chooseIprodZip': '选择 .iprod.zip',
    'builtInSamples': '内置示例',
    'reimport': '重新导入',
    'import': '导入',
    'imported': '{app} 已导入',
  ...
  'en': <String, String>{
    ...
    'importGeneratedTitle': 'Import generated bundle',
    'importGeneratedBody':
        'Choose a .iprod.zip bundle generated by Codex or another coding agent.',
    'chooseIprodZip': 'Choose .iprod.zip',
